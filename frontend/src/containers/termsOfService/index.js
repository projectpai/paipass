...
class TermsOfService extends React.Component {
  ...
  render() {
    const { goTo, loading, errorMessage, tos } = this.state;
    if (goTo) {
      return <Redirect to={goTo} />;
    }

    return (
      <div className="container-fluid term-of-service-rt">
        <LinearProgress className="loading" hidden={!loading} />
        <Header subtitle=<Localized id='terms-of-service' value="Terms of Service"/> />
