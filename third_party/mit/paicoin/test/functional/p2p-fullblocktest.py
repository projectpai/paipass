...
This reimplements tests from the paicoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure paicoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure paicoind isn't accepting b28
        ...
        tip(57)
        b59 = block(59)
        tx = create_and_sign_tx(out[17].tx, out[17].n, 1501*COIN)
        ...
        # b74/75 - if we push.py an invalid script element, all prevous sigops are counted,
        ...
        # Check that if we push.py an element filled with CHECKSIGs, they are not counted
        tip(75)
        b76 = block(76)
        ...
        #    Low-S and High-S values (whereas the paicoin code has custom code which does so);
