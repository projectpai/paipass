...
class SegWitTest(PAIcoinTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, paicoind delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let paicoind fill it in.
    ...
    def test_max_witness_push_length(self):
        ...
        self.log.info("Testing maximum witness push.py size")
    ...
    def test_tx_relay_after_segwit_activation(self):
        ...
        # Remove witness stuffing, instead add extra witness push.py on stack
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        scriptSig = CScript([p2wsh_pubkey]) # a push.py of the redeem script
        ...
        # segwit activation.  Note that older paicoind's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-paicoind> to
    # the test.
    def test_upgrade_after_activation(self, node_id):
        self.log.info("Testing software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active paicoind
    ...
    def test_witness_sigops(self):
        ...
        # would push.py us just over the block sigop limit.
